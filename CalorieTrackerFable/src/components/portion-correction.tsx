  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.labelRow}>
        <SymbolView name="scalemass" size={13} tintColor={theme.colors.inkSecondary} />
...
function CountCorrection({
  ...
  return (
    <View style={styles.wrap}>
      <View style={styles.labelRow}>
        <SymbolView name="number" size={13} tintColor={theme.colors.inkSecondary} />
      ...
      <View style={styles.countRow}>
        <Pressable onPress={() => bump(-1)} hitSlop={8} style={({ pressed }) => [styles.stepper, pressed && { backgroundColor: theme.colors.cardPressed }]}>
          <SymbolView name="minus" size={14} tintColor={theme.colors.ink} />
        </Pressable>
        <Text style={styles.countValue}>
          {count} {label}
        </Text>
        <Pressable onPress={() => bump(1)} hitSlop={8} style={({ pressed }) => [styles.stepper, pressed && { backgroundColor: theme.colors.cardPressed }]}>
          <SymbolView name="plus" size={14} tintColor={theme.colors.ink} />
        </Pressable>
      </View>
    </View>
  );
