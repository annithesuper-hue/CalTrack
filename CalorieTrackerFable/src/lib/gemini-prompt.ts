...
export const GEMINI_RESPONSE_SCHEMA = {
  ...
  required: ['isFood', 'name', 'emoji', 'calories', 'protein', 'carbs', 'fat', 'fiber', 'confidence', 'estimatedGrams', 'isCountable', 'items'],
};
...
- Always include a reasonable "fiber" estimate in grams (dietary fiber is part of carbs, not additional calories) — base it on the visible ingredients (vegetables, legumes, whole grains raise it; refined/fried foods are usually low).
